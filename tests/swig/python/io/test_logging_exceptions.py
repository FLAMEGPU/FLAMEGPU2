...
class LoggingExceptionTest(TestCase):
    ...
    def test_AgentLoggingConfigExceptions(self):
        ...
        with pytest.raises(pyflamegpu.FGPURuntimeException) as e:  # exception::InvalidArgument exception
            alcfg.logMeanFloat("float_var")
    ...
    def test_LogFrameExceptions(self):
        ...
        assert e.value.type() == "InvalidEnvProperty"
        # Property wrong type
        with pytest.raises(pyflamegpu.FGPURuntimeException) as e:  # exception::InvalidEnvPropertyType exception
    ...
    def test_AgentLogFrameExceptions(self):
        ...
        with pytest.raises(pyflamegpu.FGPURuntimeException) as e:  # exception::InvalidOperation exception
            alog.getCount()
