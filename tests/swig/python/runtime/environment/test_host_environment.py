...
class MiniSim():
    ...
    def __init__(self):
        ...
        self.ed.newPropertyArrayFloat("float_a_", MiniSim.make_array())
        self.ed.newPropertyArrayDouble("double_a_", MiniSim.make_array())
        self.ed.newPropertyArrayInt8("int8_a_", MiniSim.make_array())
        self.ed.newPropertyArrayUInt8("uint8_a_", MiniSim.make_array())
        self.ed.newPropertyArrayInt16("int16_a_", MiniSim.make_array())
        self.ed.newPropertyArrayUInt16("uint16_a_", MiniSim.make_array())
        self.ed.newPropertyArrayInt32("int32_a_", MiniSim.make_array())
        self.ed.newPropertyArrayUInt32("uint32_a_", MiniSim.make_array())
        self.ed.newPropertyArrayInt64("int64_a_", MiniSim.make_array())
        self.ed.newPropertyArrayUInt64("uint64_a_", MiniSim.make_array())
        self.ed.newPropertyArrayID("id_a_", MiniSim.make_array())
        self.ed.newPropertyArrayInt("read_only_a", MiniSim.make_array(), True)
    ...
    def run(self, steps = 2): 
        ...
        self.cudaSimulation.SimulationConfig().steps = steps
