...
+ CUDA or ROCm installation with a compatible C++20 host-compiler and build system:
  ...
  | **NVIDIA GPU** | Windows | [CUDA](https://developer.nvidia.com/cuda-downloads) `>= 12.4` | [MSVC 2022/2026](https://visualstudio.microsoft.com/) with Windows 11 SDK (`>= 10.0.22000.0`) |
  | **AMD GPU** | Linux | [ROCm/HIP](https://rocm.docs.amd.com/en/latest/) `>= 7.0` | `amdclang++` / `hipcc` with [make](https://www.gnu.org/software/make/) or [Ninja](https://ninja-build.org/) |
...
>   + Visual Studio 2026 requires CUDA >= 13.2
