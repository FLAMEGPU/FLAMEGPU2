 ...
 *
 * This class should sit between FGPU and Jitify
 */
class JitifyCache {
    /**
     * This structure acts as a key to ensure the cached version is
     * built for the right fgpu/cuda/kernel
     */
 ...
 public:
     ...
     * In the case of fgpu2, these args are likely to be the user defined function_impl and the message i/o types.
