...
class CUDASimulation : public Simulation {
...
#endif
   /**
     * Get the duration of the last call to initialiseRTC() in seconds.
    ...
    /**
     * Get the duration in seconds of each step() since the last call to `reset`
     * @return vector of step times in seconds
     */
 ...
 private:
   ...
   /**
    ...
    /**
     * Flag indicating that the model has been initialised
     */
