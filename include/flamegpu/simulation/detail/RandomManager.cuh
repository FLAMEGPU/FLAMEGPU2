...
class RandomManager {
 ...
 public:
     ...
     */
    detail::curandState*resize(size_type _length, flamegpu::detail::cuda::Stream_t stream);
    /**
     * Accessors
     */
 ...
 private:
     ...
     */
    void resizeDeviceArray(size_type _length, flamegpu::detail::cuda::Stream_t stream);
    /**
