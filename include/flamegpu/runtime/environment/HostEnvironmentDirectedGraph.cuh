...
class HostEnvironmentDirectedGraph {
 ...
 public:
    class VertexMap;
    class EdgeMap;
    HostEnvironmentDirectedGraph(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers>& _directed_graph, flamegpu::detail::gpu::Stream_t _stream, detail::CUDAScatter& _scatter, unsigned int _streamID);
    ...
    class VertexMap {
        ...
        VertexMap(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> directed_graph, flamegpu::detail::gpu::Stream_t stream);
     ...
     public:
        ...
        Vertex atIndex(unsigned int index);
         class Vertex {
          ...
          public:
             Vertex(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, flamegpu::detail::gpu::Stream_t _stream, id_t _vertex_id, bool is_index = false);
             /**
        ...
        struct Iterator {
            ...
            Iterator(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, const flamegpu::detail::gpu::Stream_t _stream, difference_type _index)
    ...
    class EdgeMap {
        ...
        EdgeMap(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> directed_graph, flamegpu::detail::gpu::Stream_t stream);
     ...
     public:
        ...
        class Edge {
         ...
         public:
            Edge(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, flamegpu::detail::gpu::Stream_t _stream, id_t _source_vertex_id, id_t _dest_vertex_id);
            Edge(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, flamegpu::detail::gpu::Stream_t _stream, unsigned int edge_index);
            /**
