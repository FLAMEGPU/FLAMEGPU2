#ifndef INCLUDE_FLAMEGPU_RUNTIME_MESSAGING_ARRAYHOST_H_
#define INCLUDE_FLAMEGPU_RUNTIME_MESSAGING_ARRAYHOST_H_
...
#endif  // INCLUDE_FLAMEGPU_RUNTIME_MESSAGING_ARRAYHOST_H_
