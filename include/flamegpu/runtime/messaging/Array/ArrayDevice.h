#ifndef INCLUDE_FLAMEGPU_RUNTIME_MESSAGING_ARRAYDEVICE_H_
#define INCLUDE_FLAMEGPU_RUNTIME_MESSAGING_ARRAYDEVICE_H_
...
#endif  // INCLUDE_FLAMEGPU_RUNTIME_MESSAGING_ARRAYDEVICE_H_
