...
>>>>>>> 8c3509e... Support for multiple CUDAAgentModel instances of same ModelDescription.
    ...
    /**
     * Get the agent's autogenerated id
     ...
     * @todo - why doesn't this work with cosnt?
     * @note - doesn't compile if included in FLAMEGPU_READ_ONLY_DEVICE_API
     */
    // __forceinline__ __device__ AgentData::IDType id() const {
    __forceinline__ __device__ AgentData::IDType id() {
