...
set(DEFAULT_FLAMEGPU_VISUALISATION_GIT_VERSION "0dd7a068d1f7e3b970baa0887dc2816ace44b33f")
...
if (FLAMEGPU_VISUALISATION_ROOT)
    ...
    if(NOT DEFINED FLAMEGPU_VISUALISATION_GIT_VERSION OR FLAMEGPU_VISUALISATION_GIT_VERSION STREQUAL "")
        set(FLAMEGPU_VISUALISATION_GIT_VERSION "${DEFAULT_FLAMEGPU_VISUALISATION_GIT_VERSION}" CACHE STRING "Git branch or tag to use for the FLAMEGPU2_visualiser")
    endif()
    ...
    if(NOT DEFINED FLAMEGPU_VISUALISATION_REPOSITORY OR FLAMEGPU_VISUALISATION_REPOSITORY STREQUAL "")
        set(FLAMEGPU_VISUALISATION_REPOSITORY "${DEFAULT_FLAMEGPU_VISUALISATION_REPOSITORY}" CACHE STRING "Remote Git Repository for the FLAMEGPU2_visualiser")
    endif()
