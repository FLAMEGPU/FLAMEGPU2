...
macro(create_pydoxygen_target FLAMEGPU_ROOT DOXY_OUT_DIR XML_PATH)
        # Seperate doxygen target for pyflamegpu
        if(NOT TARGET pyflamegpu)
            # create pyflamegpu.py ourselves
            add_subdirectory(${FLAMEGPU_ROOT}/swig)
        endif()
        SET(PYTHON_LIB_TEMP_DIRECTORY ${CMAKE_BINARY_DIR}/swig/python/${CMAKE_BUILD_TYPE})
        set(DOXYGEN_STRIP_FROM_PATH       "${PYTHON_LIB_TEMP_DIRECTORY}/pyflamegpu")
        set(DOXYGEN_STRIP_FROM_INC_PATH   "${PYTHON_LIB_TEMP_DIRECTORY}/pyflamegpu")
        set(DOXYGEN_PREDEFINED            "")
        set(DOXYGEN_PYTHON_DOCSTRING      NO)
        set(DOXY_INPUT_FILES "${PYTHON_LIB_TEMP_DIRECTORY}/pyflamegpu/pyflamegpu.py")
        if("${XML_PATH}" STREQUAL "")
            doxygen_add_docs("pydocs" "${DOXY_INPUT_FILES}")
            add_dependencies("pydocs" "pyflamegpu")
            ...
            add_dependencies("api_pydocs_xml" "pyflamegpu")
