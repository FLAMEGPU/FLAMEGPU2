...
function(create_doxygen_target FLAMEGPU_ROOT DOXY_OUT_DIR XML_PATH)
    if(DOXYGEN_FOUND)
        ...
        set(DOXYGEN_PREDEFINED            "DERIVED_FGPUException(name,default_msg)=class name: public flamegpu::FGPUException { public: explicit name(const char *format = default_msg)\; }" "VISUALISATION= ")
