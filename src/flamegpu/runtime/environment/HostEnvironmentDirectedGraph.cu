...
namespace flamegpu {
HostEnvironmentDirectedGraph::HostEnvironmentDirectedGraph(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers>& _directed_graph, const flamegpu::detail::cuda::Stream_t _stream,
...
VertexMap::VertexMap(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, const flamegpu::detail::cuda::Stream_t _stream)
...
Vertex::Vertex(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, const flamegpu::detail::cuda::Stream_t _stream, id_t _vertex_id, bool is_index)
    : directed_graph(std::move(_directed_graph))
    , stream(_stream)
...
EdgeMap::EdgeMap(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, const flamegpu::detail::cuda::Stream_t _stream)
    : directed_graph(std::move(_directed_graph))
    , stream(_stream) { }
...
Edge::Edge(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, const flamegpu::detail::cuda::Stream_t _stream, id_t _source_vertex_id, id_t _dest_vertex_id)
    : directed_graph(std::move(_directed_graph))
    , stream(_stream)
    , edge_index(directed_graph->getEdgeIndex(_source_vertex_id, _dest_vertex_id)) { }

Edge::Edge(std::shared_ptr<detail::CUDAEnvironmentDirectedGraphBuffers> _directed_graph, const flamegpu::detail::cuda::Stream_t _stream, unsigned int _edge_index)
    : directed_graph(std::move(_directed_graph))
    , stream(_stream)
