...
void EnvironmentGraphVis::setXProperty(const std::string &var_name) {
...
void EnvironmentGraphVis::setYProperty(const std::string &var_name) {
    auto it = data->graphData->vertexProperties.find(var_name);
    if (it == data->graphData->vertexProperties.end()) {
        THROW exception::InvalidEnvProperty("Property '%s' was not found within graph '%s', "
...
void EnvironmentGraphVis::setZProperty(const std::string &var_name) {
    auto it = data->graphData->vertexProperties.find(var_name);
    if (it == data->graphData->vertexProperties.end()) {
        THROW exception::InvalidEnvProperty("Property '%s' was not found within graph '%s', "
...
void EnvironmentGraphVis::setXYProperty(const std::string& var_name) {
    auto it = data->graphData->vertexProperties.find(var_name);
    if (it == data->graphData->vertexProperties.end()) {
        THROW exception::InvalidEnvProperty("Property '%s' was not found within graph '%s', "
...
void EnvironmentGraphVis::setXYZProperty(const std::string& var_name) {
    auto it = data->graphData->vertexProperties.find(var_name);
    if (it == data->graphData->vertexProperties.end()) {
        THROW exception::InvalidEnvProperty("Property '%s' was not found within graph '%s', "
