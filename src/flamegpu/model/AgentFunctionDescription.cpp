    ...
    if (agent->functions.find(function_name) == agent->functions.end()) {
        ...
        if (std::regex_search(func_src, match, rgx)) {
            if (match.size() == 4) {
                ...
                if (in_type_name == "flamegpu::MessageSpatial3D" || in_type_name == "flamegpu::MessageSpatial2D" || in_type_name == "flamegpu::MessageBruteForceSorted" || out_type_name == "flamegpu::MessageSpatial3D" || out_type_name == "flamegpu::MessageSpatial2D" || out_type_name == "flamegpu::MessageBruteForceSorted") {
